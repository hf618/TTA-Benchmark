...
path_dict = {
    ...
    "pets": ["", "/root/autodl-tmp/dataset/data_splits/split_zhou_OxfordPets.json"],
    "sun397": ["", "/root/autodl-tmp/dataset/data_splits/split_zhou_SUN397.json"],
    "caltech101": ["", "/root/autodl-tmp/dataset/data_splits/split_zhou_Caltech101.json"],
    "ucf101": ["", "/root/autodl-tmp/dataset/data_splits/split_zhou_UCF101.json"],
    "cars": ["", "/root/autodl-tmp/dataset/data_splits/split_zhou_StanfordCars.json"],
    "eurosat": ["", "/root/autodl-tmp/dataset/data_splits/split_zhou_EuroSAT.json"]
}
