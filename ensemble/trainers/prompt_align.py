...
from ensemble.PA.clip import clip
from ensemble.PA.clip import tokenize
from ensemble.PA.clip.simple_tokenizer import SimpleTokenizer as _Tokenizer
...
class PromptAlign(TrainerX):
    def save_feature_maps(self, save_path='./output/PromptAlign/features/'):
        '''
    ...
    def build_data_loader(self):
        ...
        print("cfg.TPT.VIS_VARS",self.cfg.TPT.VIS_VARS)
