...
SET_ID="sun397" # dataset identifier, have a look at data/datautils.py
...
MAPLE_FLAG="--maple" # "--maple" or empty string "". If "--maple", uses a MaPLe initialization for CLIP. This and "--templates" should be mutually exclusive.
