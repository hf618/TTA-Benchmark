...
from ensemble.zero.maple_clip.maple import CustomCLIP as MaPLeCLIP
...
def get_clip(clip_arch, device, ctx_init, 
    ...
    if not maple_weights:
        ...
        # /root/autodl-tmp/pretrained/MaPLe/cross-domain-datasets/imagenet/seed{maple_seed}/MultiModalPromptLearner
        # path_to_pretraining = f"checkpoints/maple_seed{maple_seed}.pth"
        path_to_pretraining = f"/root/autodl-tmp/pretrained/MaPLe/cross-domain-datasets/imagenet/seed{maple_seed}/MultiModalPromptLearner/maple.pth"
