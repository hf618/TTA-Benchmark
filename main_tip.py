...
from ensemble.TIP.datasets import build_dataset
from ensemble.TIP.datasets.utils import build_data_loader
import clip
from utils.utils_TIP import *
...
def main():
    ...
    # CLIP
    clip_model, _, preprocess = clip.load(cfg['backbone'])
    clip_model.eval()
